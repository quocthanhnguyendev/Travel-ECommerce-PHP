  ...
  <div class="container-scroller">
    ...
    <nav class="navbar default-layout-navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
      <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
        <h3 class="font-weight-bold">ITC TRAVEL ADMIN</h3>
      </div>
        ...
        <ul class="navbar-nav navbar-nav-right">
          <li class="nav-item nav-profile dropdown">
            ...
            <div class="dropdown-menu navbar-dropdown" aria-labelledby="profileDropdown">
              <a class="dropdown-item" href="index.php?ctrl=settings">
                <i class="mdi mdi-cached me-2 text-success"></i> Setting
              </a>

              <a class="dropdown-item" href="index.php?ctrl=home">
                <i class="mdi mdi-cached me-2 text-success"></i> Go to shop
              </a>

              <div class="dropdown-divider"></div>
              <a class="dropdown-item" href="index.php?ctrl=auth&act=logout">
    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        <ul class="nav">
          ...
          <li class="nav-item">
            <a class="nav-link" href="index.php?ctrl=admin&page=dashboard">
          ...
          <li class="nav-item">
            <a class="nav-link" data-bs-toggle="collapse" href="#ui-basic" aria-expanded="false"
              ...
              <span class="menu-title">Tourism Manager</span>
            ...
            <div class="collapse" id="ui-basic">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item">
                  <a class="nav-link" href="index.php?ctrl=admin&page=tourism">Tourism</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link" href="index.php?ctrl=admin&page=category">Category</a>
                </li>
              </ul>
            </div>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="index.php?ctrl=admin&page=order">
              <span class="menu-title">Order Manager</span>
              <i class="mdi mdi-table-large menu-icon"></i>
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="index.php?ctrl=admin&page=member">
          ...
          <li class="nav-item">
            <a class="nav-link" href="index.php?ctrl=admin&page=chart">
